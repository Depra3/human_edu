...
<!-- <form action="/signup" id="frmsign"> -->
	<table>
		...
		<tr><td>Mobile : </td>
			<td colspan="2"><input type="text" name="mobile" id="mobile" maxlength="8"></td></tr>
...
.on('click','#btnGo',function(){
	...
	$.post('/viewuser',{loginid:$('#loginid').val(),pw:$('#pw').val(),name:$('#name').val(),mobile:$('#mobile').val()},function(data){
		if(data=='ok'){
